...
export class ProjectsService
{
  ...
  insertProject(newProject: Project): Observable<Project>
  {
    var reqHeaders = new HttpHeaders();
     let Reqhed = reqHeaders.set("X-XSRF-TOKEN", sessionStorage['XSRFRequsetToken']);
    return this.httpClient.post<Project>(this.urlPrefix + "/api/projects", newProject, { headers: Reqhed, responseType: "json" });
  }
